...
def main():
    ...
    print('Starting LTR calculation {}'.format(time.strftime('%Y-%m-%d %H:%M:%S')))
    ...
    Parallel(n_jobs=2, verbose=100)(delayed(calculate_ltc)(n,G1,G2) for n in unique_nodes)

    print("Finished execution")
    print("Duration: {} seconds".format(time.time() - start_total_time))
    print
